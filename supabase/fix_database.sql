-- DANGER: This script ensures a clean slate for the MVP.
-- It works best if you delete any existing users from Authentication as well.

-- 1. Reset Schema (Drop tables to avoid conflicts)
...
CREATE TYPE public.ride_status AS ENUM ('OPEN', 'MATCHED', 'EN_ROUTE', 'ARRIVED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED');
...
CREATE TABLE public.rides (
  ...
  status public.ride_status DEFAULT 'MATCHED',
...
-- 5. Trigger for New User Creation (Robust Version)
